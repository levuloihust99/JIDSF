...
class NERContConfig:
    def __init__(self, **kwargs):
        self.data_path = "final/data/ner/all.jsonl"
        ...
        self.model_path = "NlpHUST/vibert4news-base-cased"
        ...
        self.label_embeddings_std = 0.5
        self.total_updates = 1000
        self.warmup_proportion = 0.1
        self.max_grad_norm = 1.0
        self.warmup_steps = 0
        self.seed = 12345
        self.checkpoint_dir = "checkpoints/ner_cont"
    ...
    def to_json(self):
        return {
            ...
            "label_embeddings_std": self.label_embeddings_std,
